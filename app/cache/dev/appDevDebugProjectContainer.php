...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BHMCoreBundle', 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/Resources/BHMCoreBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BHMCoreBundle', (dirname(dirname(dirname(__DIR__))).'\\src\\BHM\\CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\BHM\\CoreBundle\\Entity'))), 'BHM\\CoreBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('BHMCoreBundle' => 'BHM\\CoreBundle\\Entity'));
        ...
        $b->setProxyDir('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3d14b9d990c2ef61fc443aa90582b592c702fc3cd352bb4f597c2bc06a50799c');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('BHM\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('BHM\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('BHM\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('BHM\\CoreBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'BHM\\CoreBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('default_target_path' => 'dashboard', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $g->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainLoginService()
    {
        ...
        return $this->services['security.firewall.map.context.main_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main_login', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54af92c139394', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'main_login', NULL, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.bg.yml'), 'bg', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.de.yml'), 'de', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.it.yml'), 'it', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.pl.yml'), 'pl', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.ru.yml'), 'ru', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'BHMCoreBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\BHM\\CoreBundle/Resources/views'), 'BHMCore');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/views'), 'CoreSphereConsole');
        $instance->addPath('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('newsecret');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54af92c139394'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $this->get('security.user_checker'), 'main', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev',
            'kernel.logs_dir' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/logs',
            'kernel.bundles' => array(
                ...
                'BHMCoreBundle' => 'BHM\\CoreBundle\\BHMCoreBundle',
            ...
            'debug.container.dump' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'newsecret',
            ...
            'session.save_path' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/../web',
            'assetic.write_to' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Web/EasyPHP-DevServer-14.1VC11/data/localweb/Blue-Hood-Manager/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'BHM\\CoreBundle\\Entity\\User',
