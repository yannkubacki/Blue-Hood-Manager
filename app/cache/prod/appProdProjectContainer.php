...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'audemard', 'password' => 'aud123', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_46791c57a13fdd3a0bfa35ed1217a9753436234ef215257c821a499cd5b2d112');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_46791c57a13fdd3a0bfa35ed1217a9753436234ef215257c821a499cd5b2d112');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_46791c57a13fdd3a0bfa35ed1217a9753436234ef215257c821a499cd5b2d112');
        ...
        $d->setProxyDir('C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\src\\LP\\TestBundle/Resources/views', 'LPTest');
        $instance->addPath('C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\MrYannoch-symfonylp-ad0410dd8c32\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod',
            'kernel.logs_dir' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/logs',
            'kernel.bundles' => array(
                ...
                'LPTestBundle' => 'LP\\TestBundle\\LPTestBundle',
            ),
            ...
            'database_user' => 'audemard',
            'database_password' => 'aud123',
            ...
            'session.save_path' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/../web',
            'assetic.write_to' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/MrYannoch-symfonylp-ad0410dd8c32/app/cache/prod/doctrine/orm/Proxies',
